...
class DealTypeOnePage extends StatefulWidget {
  const DealTypeOnePage({super.key});

  @override
  _DealTypeOnePageState createState() => _DealTypeOnePageState();
}

class _DealTypeOnePageState extends State<DealTypeOnePage>
