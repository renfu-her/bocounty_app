...
class _RGuildPageState extends State<RGuildPage> {
  ...
  Future<void> _post(apiUrl) async {
    ...
    try {
      http.Response response = await http.post(Uri.parse(Posturl), headers: headers, body: jsonData);
                                ...
                                Container(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: const InputDecoration(
                                      hintText: '標題',
                                      hintStyle: TextStyle(color: const Color(0xff757575),fontSize: 12,letterSpacing: 5),
                                      border: InputBorder.none,
                                      contentPadding: EdgeInsets.symmetric(vertical: 13.5,horizontal: 12),
                                    ),
                                  ),
                                ),
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              ...
                                              child: Padding(
                                                ...
                                                child: isChecked? Icon(Icons.circle,size: 10.0,color: Colors.black,):
                                                Icon(Icons.circle,size: 10.0,color: const Color(0xfff5eeda),),
                                              )
                                            ),
                                            SizedBox(width: screenWidth*0.01,),
                                            Text(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              GestureDetector(
                                                  ...
                                                  child: Padding(
                                                    padding: const EdgeInsets.only(top: 2,left: 2),
                                                    child: isChecked? Icon(Icons.circle,size: 10.0,color: const Color(0xfff5eeda),)
                                                        :Row(
                                                      children: [
